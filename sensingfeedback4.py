...
#let the app know youre working
readConfig()
...
while 1:
	...
	if time.time() - start > 5:
		try:
			start = time.time()
			requests.post('http://184.72.68.192:3000/api/heartbeat',json={'heat':temperature})
			params = eval(requests.get('http://184.72.68.192:3000/api/params').content)
