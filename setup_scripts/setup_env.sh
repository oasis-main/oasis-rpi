...
. /home/pi/oasis-cpu/setup_scripts/install_rust.sh

echo "Installing Python Modules..."
python3 -m venv /home/pi/oasis-cpu/oasis_venv_pi #uncomment to build env from source
...
/usr/bin/env python3 -m pip install -r /home/pi/oasis-cpu/requirements.txt #uncomment to build env from source

echo "Installing Rust Modules..."
cd ..
cd /home/pi/oasis-cpu/rusty_pins
cargo build
maturin develop
maturin build --release
cd ..
cd /home/pi/oasis-cpu/rusty_pipes
cargo build
maturin develop
maturin build --release
