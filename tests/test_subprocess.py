...
if __name__ == '__main__':
    ...
    test1 = rusty_pipes.Open(["python3", "test_child.py"])
    test1.wait()
    ...
    test2 = rusty_pipes.Open(["python3", "test_child.py"])
    ...
    test3 = rusty_pipes.Open(["python3", "test_child.py"])
    ...
    test4 = rusty_pipes.Open(["python3", "test_child.py"])
    time.sleep(1)
